...
public class FoodBuildUI extends Application {
    ...
    public FoodData foodList = new FoodData();
    ...
    public void start(Stage primaryStage) {
        ...
        runNutrientQuery.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (!foodList.filterByNutrients(filtersList).get(0).getName().equals("zzIncorrect")) {
                    currentFilterList.clear(); // clear old view
                    food.clear();
                    currentFilterList.addAll(filtersList); // add all filters to the displayed view
        ...
        analyzeMeal.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                Meal curMeal = (Meal) mealView.getSelectionModel().getSelectedItem();
                double [] nutritionArray = new double[5];
                nutritionArray = curMeal.analyzeMealNutrition();
        ...
        // clearing the import list button
        ...
        foodView.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent click) {
                if (click.getClickCount() == 2) {
                   ...
                   Button addMeal = new Button ("Add to Meal!");
                   okay.setPrefSize(150, 20);
                   addMeal.setPrefSize(150, 20);
                   ...
                   Meal curMeal = mealView.getSelectionModel().getSelectedItem();
                   if (curMeal!=null) {
                       foodCheck.add(addMeal, 0, 8,1,1);
                   }
                   Scene foodCheckScene = new Scene(foodCheck, 320, 250);
                   ...
                   addMeal.setOnAction(new EventHandler<ActionEvent>() {
                       @Override
                       public void handle(ActionEvent event) {
                           curMeal.addFood(currentItemSelected);
                           CheckFood.close();
                       }
                   });
                }
