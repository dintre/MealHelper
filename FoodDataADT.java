...
public interface FoodDataADT<F extends Food> {
     ...
     *        (e.g. folder1/subfolder1/.../Foods.csv) 
     */
     ...
     *     2. The whole substring should be present in the name of Food object.
     ...
     *     2. A FoodADT object MUST satisfy ALL the provided rules i
     ...
     * @param Food the food item instance to be added
     */
